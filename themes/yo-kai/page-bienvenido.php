<?php get_header(); ?>
	...
	<div class="[ margin-bottom margin-auto ][ width--600p ]">
		<div class="[ border-top--primary ][ padding-top--large padding-bottom--large ][ text-uppercase ]">
			...
			<p>Si tienes alguna duda, escríbenos desde la sección de ayuda y responderemos lo más rápido posible a esta dirección de correo.</p>
			<p>¡Si esres el papá, la mamá o el tutor del niño participante, muéstrale este correo por favor!</p>
			<p>Estos son los datos de tu cuenta. ¡Buena suerte!</p>

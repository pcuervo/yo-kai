<?php get_header(); ?>
	...
	<div class="row [ margin-bottom--large ]">
		...
		<div class="col-xs-8">
			...
			<!-- <h2 class="[ text-center ][ padding-bottom--small ][ color-primary ][ border-bottom--primary ][ margin-top--xxlarge ]">Estas son las posiciones finales. ¡Sigue usando el album digital!</h2> -->
		</div>
	</div>

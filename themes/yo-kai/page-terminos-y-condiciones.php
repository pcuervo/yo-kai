<?php get_header(); the_post(); ?>
	...
	<h2 class="[ color-primary ][ text-center ]">Términos y condiciones</h2>
	<div class="[ text-center ][ margin-bottom--large margin-auto ][ width--800p ]">
		<div class="[ border-bottom--primary border-top--primary ][ padding-top--large padding-bottom--large ]" data-parsley-validate>
			<?php the_content(); ?>	
		</div>
	</div>

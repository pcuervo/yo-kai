...
$category_slug = isset($_GET['cat']) ? $_GET['cat'] : ''; ?>
	...
	<div class="modal fade" id="concurso-terminado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content [ font-peace_sansregular ]">
				<img src="<?php echo THEMEPATH; ?>images/logo.png" alt="logo yo-kai watch">
				<p class="[ color-primary ]">EL CONCURSO POR LOS PREMIOS HA TERMINADO. PUEDES SEGUIR USANDO EL ÁLBUM DIGITAL PARA DIVERTIRTE, PERO EL RANKING YA NO REGISTRARÁ MOVIMIENTOS A PARTIR DEL 5 DE ENERO DE 2017 A LAS 14 HR.</p>
